...
Проект "Чистый банк" представляет собой дизайн и реализацию RESTful API, бэк-сервиса и модели данных для создания банковских счетов и выполнения переводов между ними. Взаимодействие с API будет осуществляться с помощью HTTP-запросов.
...
Для использования этой программы необходимо настроить и запустить приложение "Чистый банк". Вы можете выполнять HTTP-запросы к определенным эндпоинтам для взаимодействия с банковскими счетами.
